...
<section class="mt2Rem mb2Rem py-05Rem">
    ...
    <p class="mb05Rem fwB">【コマ数】 : 70分 × 2コマ</p>
    <p class="mb05Rem fwB">【価格】各5,000円（税込 / 教材付き）</p>
    <p class="mb05Rem fwB">【見逃し配信】配信直後 ～ 第114回国試当日の朝まで</p>
    <p class="mb05Rem pl05Rem fwB">※受講形態にかかわらず、見逃し配信をご視聴いただけます。</p>
    <p class="mb05Rem fwB">【オリジナル教材】</p>
    <p class="mb05Rem fwB">対面講座 : 当日配布</p>
    <p class="mb05Rem fwB">Zoom配信 : 2025年2月1日（土） からマイページよりダウンロードまたは印刷可能</p>
    <p class="fwB"><a href="#youtubeMovie" class="fColor-Blue">詳しい動画の説明はこちら>></a></p>
</section>
...
<map id="youtubeMovie"><!--youtube Movie--></map>
                </a>
            </div>
        </div>
    </div>
...
<section class="mb4Rem">
    <h2 class="section-heading"><i class="fam fa-solid fa-video mr05Rem"></i>動画で見る 看護国試前日講座</h2>
    <div class="youtube-movie">
        <iframe src="https://www.youtube.com/embed/p061FmL52cA" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </div>
</section>

<!-- 全国 Zoom配信 -->
<section id="mapAreaB" class="zoom-section">
    <map id="national"><!--全国Zoom配信--></map>
    <div class="container">
        ...
        <div class="zoom-card bd-grape">
            ...
            <div class="zoom-card-content">
                <div class="info-box">
                    ...
                    <p class="titleTxt">2025年2月15日（土）</p>
                    <p class="d-block titleTxt">14:00 ～ 16:30</p>
        ...
        <div class="zoom-card bd-lightBlue_B">
            ...
            <div class="zoom-card-content">
                <div class="info-box">
                    ...
                    <p class="titleTxt">2025年2月15日（土）</p>
                    <p class="d-block titleTxt">10:00 ～ 12:30</p>
